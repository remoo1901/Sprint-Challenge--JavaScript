...
This is often used within a constructor function to call the parent constructor function. ...
 In this example we have a Dog class which extends an Animal class. The Dog class uses the super keyword twice.
